...
int testIntegrator(const PathToJson &path) {
  ...
  error1 = stateToVector(integrator.EF(xk1, uk1, Ts)) -
           stateToVector(integrator.RK4(xk1, uk1, Ts));
  std::cout << "hand picked point RK4 - EF error = " << error1.norm()
            << std::endl;
  //////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  error2 = stateToVector(integrator.EF(xk2, uk2, Ts)) -
           stateToVector(integrator.RK4(xk2, uk2, Ts));
  ...
  error3 = stateToVector(integrator.EF(xk3, uk3, Ts)) -
           stateToVector(integrator.RK4(xk3, uk3, Ts));
  std::cout << "random RK4 - EF error = " << error3.norm() << std::endl;
  //////////////////////////////////////////////////////////////////////////////////////////////////////////
  // test how good fit is
  if (error1.norm() / 10.0 <= 0.3 && error2.norm() / 10.0 <= 0.3 &&
      error3.norm() / 10.0 <= 0.3) {
    return 1;
  } else {
    return 0;
  }
...
int testLinModel(const PathToJson &path) {
  ...
  // 3 differnet test cases, hand picked, going straight and test how good
  ...
  error1 =
      (lin_model_d1.A * xk1_vec + lin_model_d1.B * uk1_vec + lin_model_d1.g) -
      stateToVector(integrator.RK4(xk1, uk1, Ts));
  std::cout << "hand picked point RK4 - lin error = " << error1.norm()
            << std::endl;
  //////////////////////////////////////////////////////////////////////////////////////////////////////////
  // x and u corresponding to going straight with 1m/s
  StateVector error2;
  ...
  error2 =
      (lin_model_d2.A * xk2_vec + lin_model_d2.B * uk2_vec + lin_model_d2.g) -
      stateToVector(integrator.RK4(xk2, uk2, Ts));
  ...
  error3 =
      (lin_model_d1.A * xk3_vec + lin_model_d1.B * uk3_vec + lin_model_d1.g) -
      stateToVector(integrator.RK4(xk3, uk3, Ts));
  //    std::cout << error3 << std::endl;
  std::cout << "generalization test RK4 - lin error = " << error3.norm()
            << std::endl;
