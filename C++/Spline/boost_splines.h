...
class BoostSplines {
 public:
  ...
  BoostSplines();
  explicit BoostSplines(const PathToJson &path);

 private:
  void genPathSplines(const Eigen::VectorXd &s, const Eigen::VectorXd &X,
                      const Eigen::VectorXd &Y);
  void genBoarderSplines(const Eigen::VectorXd &s,
